package com.springboot.microservices.applicationsgateway.configuration;
...
public class CustomPreFilter implements GlobalFilter
{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain)
    {
        ...
        customPreFilterLogger.info("Authorization : " + preRequest.getHeaders().getFirst("Authorization"));
