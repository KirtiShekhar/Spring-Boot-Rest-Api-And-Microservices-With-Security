...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<ErrorResponse> handleNameNotFoundError(StudentNameNotFoundException nnfe)
    {
    ...
    public ResponseEntity<ErrorResponse> handleProductNotFound(StudentNotFoundException pnfe)
    {
        ErrorResponse errorResponse = new ErrorResponse();
