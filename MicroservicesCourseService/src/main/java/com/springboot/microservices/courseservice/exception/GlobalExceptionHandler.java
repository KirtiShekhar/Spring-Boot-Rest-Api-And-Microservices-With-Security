...
public class GlobalExceptionHandler
{
    ...
    public ResponseEntity<ErrorResponse> handleNameNotFoundError(CourseNameNotFoundException nnfe)
    {
    ...
    public ResponseEntity<ErrorResponse> handleProductNotFound(CourseNotFoundException pnfe)
    {
        ErrorResponse errorResponse = new ErrorResponse();
